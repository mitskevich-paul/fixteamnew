...
repearScreen.addEventListener('click', () => alertas(`Установка ОС`));
repearBattery.addEventListener('click', () => alertas(`Установка ПО`));
repearPort.addEventListener('click', () => alertas(`Чистка аппаратная`));
repearCamera.addEventListener('click', () => alertas(`Ремонт ноутбука`)); 
repearBody.addEventListener('click', () => alertas(`Ремонт ПК`));
repearOther.addEventListener('click', () => alertas(`Сборка ПК`));

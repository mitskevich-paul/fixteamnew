...
repearBattery.addEventListener('click', () => alertas(`Замена батареи планшета`));
repearPort.addEventListener('click', () => alertas(`Замена порта планшета`));
repearCamera.addEventListener('click', () => alertas(`Другое (планшет)`));